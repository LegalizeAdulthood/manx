...
class ApiSiteUnknownPathsTest extends PHPUnit\Framework\TestCase
{
    public function setUp()
    {
        ...
        $this->_api = new Manx\Api\SiteUnknownPaths($this->_config);
    }
    ...
    public function testGetRequiresLogin()
    {
        ...
        $rows = [];
        $this->_db->expects($this->never())->method('getSiteUnknownPaths');
