<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html lang="en"><head><title>Manx</title>
...
<div class="det"><form id="LOGINFORM" method="post" action="http://vt100.netlogin.php">
<table id="LOGINBOX">
<tbody>
...
<tr><td colspan="2"><input type="submit" id="LOGIBUTT" name="LOGI" value="Login"><input type="hidden" name="redirect" value="http://vt100.nethelp.php?q=;cp=1"></td></tr>
</tbody></table></form>
